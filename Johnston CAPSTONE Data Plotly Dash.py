...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        fig1=px.pie(filtered_df,values='class count',names='class',title="Total Success Launches for " +entered_site)
        return fig1
...
def get_scatter_chart(entered_site, slider_range):
    ...
    if entered_site == 'ALL':
        fig2 = px.scatter(filtered_df1, x='Payload Mass (kg)', y='class', color='Booster Version Category',
